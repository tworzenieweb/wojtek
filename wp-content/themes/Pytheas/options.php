...
function optionsframework_options() {
	...
	$options['home_tagline'] = array(
		'name' => __('Homepage Tagline', 'wpex','wpex'),
		'desc' => __('Enter your homepage tagline content. Leave blank to show nothing.', 'wpex','wpex'),
		'id' => 'home_tagline',
		'std' => __('Homepage Tagline Sample','wpex'),
		'type' => 'textarea');
		
	$options['home_services_title'] = array(
		'name' => __('Homepage Services Title', 'wpex','wpex'),
		'desc' => __('Enter your homepage services title.', 'wpex','wpex'),
	...
	$options['home_services_count'] = array(
		'name' => __('How Manny Services Posts', 'wpex','wpex'),
