...
<div id="home-wrap" class="clr">
	...
	/* Tagline
	/*--------------------------------------*/
    if( of_get_option('home_tagline','Home Tagline Sample') !== '' ) { ?>
	...
	/*--------------------------------------*/
    if( of_get_option('home_services','1') == '1' ) {
		...
		<div id="home-services">		
			<?php
			// Display heading
			if( of_get_option('home_services_title') ) { ?>
				<h2 class="heading">
	...
	/*--------------------------------------*/
    if( of_get_option('home_portfolio','1') == '1' ) {
	...
	/*--------------------------------------*/
    if( of_get_option('home_blog','1') == '1' ) {
