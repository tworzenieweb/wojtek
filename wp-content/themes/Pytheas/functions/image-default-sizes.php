...
if ( ! function_exists( 'wpex_img' ) ) :
	...
	function wpex_img($args){
		...
		//blog home entries
		if( $args == 'blog_home_entry_width' ) return '650';
		if( $args == 'blog_home_entry_height' ) return '400';
		...
		if( $args == 'blog_related_entry_width' ) return '650';
		if( $args == 'blog_related_entry_height' ) return '400';
		...
		//portfolio entries
		if( $args == 'portfolio_entry_width' ) return '650';
		if( $args == 'portfolio_entry_height' ) return '400';
		if( $args == 'portfolio_entry_crop' ) return true;

		//portfolio related entries
		if( $args == 'portfolio_related_entry_width' ) return '650';
		if( $args == 'portfolio_related_entry_height' ) return '400';
