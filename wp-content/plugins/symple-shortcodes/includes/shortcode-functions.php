 ...
 * @since v1.1
 */
if (!function_exists('symple_youtube_shortcode')) {

    function symple_youtube_shortcode($atts)
    {
        extract(shortcode_atts(array(
            'width' => '100%',
            'height' => '315px',
        ...
        return sprintf('<iframe width="%s" height="%s" src="http://www.youtube.com/embed/%s" frameborder="0" allowfullscreen></iframe>', $width, $height, $src);
    }

    add_shortcode('symple_youtube', 'symple_youtube_shortcode');
}
