	...
	*/
	function widget($args, $instance){
		...
		if (strlen($pageURL) > 23) {	
			...
			$like_box_xfbml = "<script src=\"http://connect.facebook.net/pl_PL/all.js#xfbml=1\"></script><fb:like-box href=\"$pageURL\" width=\"$width\" show_faces=\"$showFaces\" border_color=\"$borderColor\" stream=\"$streams\" header=\"$header\"></fb:like-box>";
		} else {
			...
			$like_box_xfbml = "<script src=\"http://connect.facebook.net/pl_PL/all.js#xfbml=1\"></script><fb:like-box id=\"$pageID\" width=\"$width\" show_faces=\"$showFaces\" border_color=\"$borderColor\" stream=\"$streams\" header=\"$header\"></fb:like-box>";		
		}
